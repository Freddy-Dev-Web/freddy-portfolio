...
export const serviceData = [
    ...
    { 
        ...
        title: 'App web', 
        description: 'App web development involves creating app web for everyone...', 
        link: '' 
    },
    { 
        icon: assets.ui_icon, 
...
export const infoList = [
    { 
        ...
        title: 'Languages', 
        description: 'HTML, CSS, JavaScript, Zod, React Js, Next Js,' 
    },
    { 
        icon: assets.edu_icon, 
        iconDark: assets.edu_icon_dark, 
        title: 'Education', 
        description: 'Startup IKOUE (Academy)' 
...
export const NAV_LINKS = [
    ...
    { href: '#about', key: 'About me', label: 'About Me' },
    { href: '#services', key: 'services', label: 'Services' },
    { href: '#work', key: 'work', label: 'My Work ' },
